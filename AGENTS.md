...
|---|---|---|
| Turn/round state machine | `TestDebateStateMachineReachesConsensus`, `TestTurnOrderSurvivesSubSecondJoinTimes` | enforced by `make check` |
