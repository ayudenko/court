...
|---|---|---|
| Turn/round state machine | `TestDebateStateMachineReachesConsensus`, `TestTurnOrderSurvivesSubSecondJoinTimes`, `TestStuckModerationResumesWithoutRestart`, `TestModerationAttemptBookkeepingHoldsTheSinglePass`, `TestModerationRetryBacksOff`, `TestLateResumeDoesNotRemoderateAConcludedDebate` | enforced by `make check` |
